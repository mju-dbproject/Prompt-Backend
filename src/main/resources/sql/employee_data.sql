...
VALUES ( null, 'admin01', '$2a$10$k/JAofWoHWEP1Xz6pW9rseoAOltZRJ4lZga6/aD/REISTuCaZwilS', '151001', '관리자1','admin001@gmail.com', '12345678-00000001', '010-0000-0001', '명지대학교 졸업', 10,
        '2016-03-01 13:10:00', true, null, 'DIRECTOR', 'DIRECTOR', 'ADMIN', false);

INSERT INTO employee(id, user_id, password, employee_number, name, email,register_number, phone_number, education,
                     experience_year, entering_date, approved,skill, c_rank, position, role, deleted)
VALUES ( null, 'admin02', '$2a$10$k/JAofWoHWEP1Xz6pW9rseoAOltZRJ4lZga6/aD/REISTuCaZwilS', '151002', '관리자2','admin002@gmail.com', '12345678-00000002', '010-0000-0002', '명지대학교 졸업', 10,
         '2016-03-01 13:10:00', true, null, 'DIRECTOR', 'DIRECTOR', 'ADMIN', false);
...
INSERT INTO employee(id, user_id, password, employee_number, name, email,register_number, phone_number, education,
                     experience_year, entering_date, approved,skill, c_rank, position, role, deleted)
VALUES ( null, 'test002', '$2a$10$k/JAofWoHWEP1Xz6pW9rseoAOltZRJ4lZga6/aD/REISTuCaZwilS', '191001', '직원2','tester002@gmail.com', '12345678-00000012', '010-0000-0012', '명지대학교 졸업', 10,
